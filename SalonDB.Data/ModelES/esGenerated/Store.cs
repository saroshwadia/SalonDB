...
namespace BusinessObjects
{
	...
	public partial class Store : esStore
	{
		...
		#region CustomerCollectionByStoreID - Zero To Many
		
		static public esPrefetchMap Prefetch_CustomerCollectionByStoreID
		{
			get
			{
				esPrefetchMap map = new esPrefetchMap();
				map.PrefetchDelegate = BusinessObjects.Store.CustomerCollectionByStoreID_Delegate;
				map.PropertyName = "CustomerCollectionByStoreID";
				map.MyColumnName = "StoreID";
				map.ParentColumnName = "StoreID";
				map.IsMultiPartKey = false;
				return map;
		...
		static private void CustomerCollectionByStoreID_Delegate(esPrefetchParameters data)
		{
			StoreQuery parent = new StoreQuery(data.NextAlias());
		...
		[XmlIgnore]
		public CustomerCollection CustomerCollectionByStoreID
		{
			get
			{
				if(this._CustomerCollectionByStoreID == null)
				{
					this._CustomerCollectionByStoreID = new CustomerCollection();
					this._CustomerCollectionByStoreID.es.Connection.Name = this.es.Connection.Name;
					this.SetPostSave("CustomerCollectionByStoreID", this._CustomerCollectionByStoreID);
				
					if (this.StoreID != null)
					{
						if (!this.es.IsLazyLoadDisabled)
						{
							this._CustomerCollectionByStoreID.Query.Where(this._CustomerCollectionByStoreID.Query.StoreID == this.StoreID);
							this._CustomerCollectionByStoreID.Query.Load();
						}

						// Auto-hookup Foreign Keys
						this._CustomerCollectionByStoreID.fks.Add(CustomerMetadata.ColumnNames.StoreID, this.StoreID);
					}
				}

				return this._CustomerCollectionByStoreID;
			}
			...
			{ 
				...
				if (this._CustomerCollectionByStoreID != null) 
				{ 
					this.RemovePostSave("CustomerCollectionByStoreID"); 
					this._CustomerCollectionByStoreID = null;
					this.OnPropertyChanged("CustomerCollectionByStoreID");
				} 
			} 			
		}
			
		
		private CustomerCollection _CustomerCollectionByStoreID;
		#endregion
		...
		#region TransactionCollectionByStoreID - Zero To Many
		
		static public esPrefetchMap Prefetch_TransactionCollectionByStoreID
		{
			get
			{
				esPrefetchMap map = new esPrefetchMap();
				map.PrefetchDelegate = BusinessObjects.Store.TransactionCollectionByStoreID_Delegate;
				map.PropertyName = "TransactionCollectionByStoreID";
				map.MyColumnName = "StoreID";
				map.ParentColumnName = "StoreID";
				map.IsMultiPartKey = false;
				return map;
		...
		static private void TransactionCollectionByStoreID_Delegate(esPrefetchParameters data)
		{
			StoreQuery parent = new StoreQuery(data.NextAlias());
		...
		[XmlIgnore]
		public TransactionCollection TransactionCollectionByStoreID
		{
			get
			{
				if(this._TransactionCollectionByStoreID == null)
				{
					this._TransactionCollectionByStoreID = new TransactionCollection();
					this._TransactionCollectionByStoreID.es.Connection.Name = this.es.Connection.Name;
					this.SetPostSave("TransactionCollectionByStoreID", this._TransactionCollectionByStoreID);
				
					if (this.StoreID != null)
					{
						if (!this.es.IsLazyLoadDisabled)
						{
							this._TransactionCollectionByStoreID.Query.Where(this._TransactionCollectionByStoreID.Query.StoreID == this.StoreID);
							this._TransactionCollectionByStoreID.Query.Load();
						}

						// Auto-hookup Foreign Keys
						this._TransactionCollectionByStoreID.fks.Add(TransactionMetadata.ColumnNames.StoreID, this.StoreID);
					}
				}

				return this._TransactionCollectionByStoreID;
			}
			...
			{ 
				...
				if (this._TransactionCollectionByStoreID != null) 
				{ 
					this.RemovePostSave("TransactionCollectionByStoreID"); 
					this._TransactionCollectionByStoreID = null;
					this.OnPropertyChanged("TransactionCollectionByStoreID");
				} 
			} 			
		}
			
		
		private TransactionCollection _TransactionCollectionByStoreID;
		#endregion
		...
		protected override esEntityCollectionBase CreateCollectionForPrefetch(string name)
		{
			...
			switch (name)
			{
				case "AppointmentCollectionByStoreID":
					...
					break;
				case "CustomerCollectionByStoreID":
					coll = this.CustomerCollectionByStoreID;
					break;
				...
				case "StaffHourCollectionByStoreID":
					...
					break;
				case "TransactionCollectionByStoreID":
					coll = this.TransactionCollectionByStoreID;
					break;	
			}
		...
		protected override List<esPropertyDescriptor> GetHierarchicalProperties()
		{
			...
			props.Add(new esPropertyDescriptor(this, "CustomerCollectionByStoreID", typeof(CustomerCollection), new Customer()));
			...
			props.Add(new esPropertyDescriptor(this, "TransactionCollectionByStoreID", typeof(TransactionCollection), new Transaction()));
		...
		protected override void ApplyPostSaveKeys()
		{
			...
			if(this._CustomerCollectionByStoreID != null)
			{
				Apply(this._CustomerCollectionByStoreID, "StoreID", this.StoreID);
			}
			if(this._StaffCollectionByStoreID != null)
			{
			...
			if(this._TransactionCollectionByStoreID != null)
			{
				Apply(this._TransactionCollectionByStoreID, "StoreID", this.StoreID);
			}
		}
