...
namespace BusinessObjects
{
	...
	abstract public partial class esCustomer : EntityBase
	{
		...
		virtual public System.Guid? StoreID
		{
			get
			{
				return base.GetSystemGuid(CustomerMetadata.ColumnNames.StoreID);
			}
			
			set
			{
				if(base.SetSystemGuid(CustomerMetadata.ColumnNames.StoreID, value))
				{
					this._UpToStoreByStoreID = null;
					this.OnPropertyChanged("UpToStoreByStoreID");
					OnPropertyChanged(CustomerMetadata.PropertyNames.StoreID);
				}
			}
		}		
	...
	abstract public partial class esCustomerQuery : QueryBase
	{
		...
		{
			get { return new esQueryItem(this, CustomerMetadata.ColumnNames.StoreID, esSystemType.Guid); }
		} 
	...
	public partial class Customer : esCustomer
	{
		...
		#region TransactionCollectionByCustomerID - Zero To Many
		
		static public esPrefetchMap Prefetch_TransactionCollectionByCustomerID
		{
			get
			{
				esPrefetchMap map = new esPrefetchMap();
				map.PrefetchDelegate = BusinessObjects.Customer.TransactionCollectionByCustomerID_Delegate;
				map.PropertyName = "TransactionCollectionByCustomerID";
				map.MyColumnName = "CustomerID";
				map.ParentColumnName = "CustomerID";
				map.IsMultiPartKey = false;
				return map;
		...
		static private void TransactionCollectionByCustomerID_Delegate(esPrefetchParameters data)
		{
			CustomerQuery parent = new CustomerQuery(data.NextAlias());
		...
		[XmlIgnore]
		public TransactionCollection TransactionCollectionByCustomerID
		{
			get
			{
				if(this._TransactionCollectionByCustomerID == null)
				{
					this._TransactionCollectionByCustomerID = new TransactionCollection();
					this._TransactionCollectionByCustomerID.es.Connection.Name = this.es.Connection.Name;
					this.SetPostSave("TransactionCollectionByCustomerID", this._TransactionCollectionByCustomerID);
				
					if (this.CustomerID != null)
					{
						if (!this.es.IsLazyLoadDisabled)
						{
							this._TransactionCollectionByCustomerID.Query.Where(this._TransactionCollectionByCustomerID.Query.CustomerID == this.CustomerID);
							this._TransactionCollectionByCustomerID.Query.Load();
						}

						// Auto-hookup Foreign Keys
						this._TransactionCollectionByCustomerID.fks.Add(TransactionMetadata.ColumnNames.CustomerID, this.CustomerID);
					}
				}

				return this._TransactionCollectionByCustomerID;
			}
			...
			{ 
				...
				if (this._TransactionCollectionByCustomerID != null) 
				{ 
					this.RemovePostSave("TransactionCollectionByCustomerID"); 
					this._TransactionCollectionByCustomerID = null;
					this.OnPropertyChanged("TransactionCollectionByCustomerID");
				} 
			} 			
		}
			
		
		private TransactionCollection _TransactionCollectionByCustomerID;
		#endregion
		...
		/// <summary>
		/// Many to One
		/// Foreign Key Name - FK_Customer_Store
		/// </summary>
		...
		protected override esEntityCollectionBase CreateCollectionForPrefetch(string name)
		{
			...
			switch (name)
			{
				case "AppointmentCollectionByCustomerID":
					...
					break;
				case "TransactionCollectionByCustomerID":
					coll = this.TransactionCollectionByCustomerID;
					break;	
			}
		...
		protected override List<esPropertyDescriptor> GetHierarchicalProperties()
		{
			...
			props.Add(new esPropertyDescriptor(this, "TransactionCollectionByCustomerID", typeof(TransactionCollection), new Transaction()));
		...
		protected override void ApplyPostSaveKeys()
		{
			...
			if(this._TransactionCollectionByCustomerID != null)
			{
				Apply(this._TransactionCollectionByCustomerID, "CustomerID", this.CustomerID);
			}
		}
	...
	public partial class CustomerMetadata : esMetadata, IMetadata
	{
		...
		protected CustomerMetadata()
		{
			...
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.StoreID, 1, typeof(System.Guid), esSystemType.Guid);
			c.PropertyName = CustomerMetadata.PropertyNames.StoreID;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.CompanyID, 2, typeof(System.Guid), esSystemType.Guid);
			c.PropertyName = CustomerMetadata.PropertyNames.CompanyID;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.FirstName, 3, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.FirstName;
			c.CharacterMaxLength = 50;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.LastName, 4, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.LastName;
			c.CharacterMaxLength = 50;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.Phone, 5, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.Phone;
			c.CharacterMaxLength = 50;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.Email, 6, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.Email;
			c.CharacterMaxLength = 50;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.Address, 7, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.Address;
			c.CharacterMaxLength = 500;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.City, 8, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.City;
			c.CharacterMaxLength = 50;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.PostalCode, 9, typeof(System.String), esSystemType.String);
			c.PropertyName = CustomerMetadata.PropertyNames.PostalCode;
			c.CharacterMaxLength = 50;
			c.IsNullable = true;
			m_columns.Add(c);
				
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.Discount, 10, typeof(System.Decimal), esSystemType.Decimal);
			...
			c = new esColumnMetadata(CustomerMetadata.ColumnNames.Notes, 11, typeof(System.String), esSystemType.String);
