...
namespace BusinessObjects
{
	...
	abstract public partial class esStaff : EntityBase
	{
		...
		/// </summary>
		[DataMember(EmitDefaultValue=false)]
		virtual public System.String ResourceColor
		{
			get
			{
				return base.GetSystemString(StaffMetadata.ColumnNames.ResourceColor);
			}
			
			set
			{
				if(base.SetSystemString(StaffMetadata.ColumnNames.ResourceColor, value))
				{
				...
				else
				{
					...
					{	
						...
						case "ResourceColor":
							...
							if (value == null || value is System.String)
								this.ResourceColor = (System.String)value;
								OnPropertyChanged(StaffMetadata.PropertyNames.ResourceColor);
							break;
		...
		sealed public class esStrings
		{
			...
			public System.String ResourceColor
			{
				get
				{
					System.String data = entity.ResourceColor;
					return (data == null) ? String.Empty : Convert.ToString(data);
				}
				...
				set
				{
					...
					else entity.ResourceColor = Convert.ToString(value);
				}
			}
	...
	public partial class Staff : esStaff
	{
		...
		#region TransactionCollectionByStaffID - Zero To Many
		
		static public esPrefetchMap Prefetch_TransactionCollectionByStaffID
		{
			get
			{
				esPrefetchMap map = new esPrefetchMap();
				map.PrefetchDelegate = BusinessObjects.Staff.TransactionCollectionByStaffID_Delegate;
				map.PropertyName = "TransactionCollectionByStaffID";
				map.MyColumnName = "StaffID";
				map.ParentColumnName = "StaffID";
				map.IsMultiPartKey = false;
				return map;
		...
		static private void TransactionCollectionByStaffID_Delegate(esPrefetchParameters data)
		{
			StaffQuery parent = new StaffQuery(data.NextAlias());
		...
		[XmlIgnore]
		public TransactionCollection TransactionCollectionByStaffID
		{
			get
			{
				if(this._TransactionCollectionByStaffID == null)
				{
					this._TransactionCollectionByStaffID = new TransactionCollection();
					this._TransactionCollectionByStaffID.es.Connection.Name = this.es.Connection.Name;
					this.SetPostSave("TransactionCollectionByStaffID", this._TransactionCollectionByStaffID);
				
					if (this.StaffID != null)
					{
						if (!this.es.IsLazyLoadDisabled)
						{
							this._TransactionCollectionByStaffID.Query.Where(this._TransactionCollectionByStaffID.Query.StaffID == this.StaffID);
							this._TransactionCollectionByStaffID.Query.Load();
						}

						// Auto-hookup Foreign Keys
						this._TransactionCollectionByStaffID.fks.Add(TransactionMetadata.ColumnNames.StaffID, this.StaffID);
					}
				}

				return this._TransactionCollectionByStaffID;
			}
			...
			{ 
				...
				if (this._TransactionCollectionByStaffID != null) 
				{ 
					this.RemovePostSave("TransactionCollectionByStaffID"); 
					this._TransactionCollectionByStaffID = null;
					this.OnPropertyChanged("TransactionCollectionByStaffID");
				} 
			} 			
		}
			
		
		private TransactionCollection _TransactionCollectionByStaffID;
		#endregion
		...
		protected override esEntityCollectionBase CreateCollectionForPrefetch(string name)
		{
			...
			switch (name)
			{
				...
				case "StaffHourCollectionByStaffID":
					...
					break;
				case "TransactionCollectionByStaffID":
					coll = this.TransactionCollectionByStaffID;
					break;	
			}
		...
		protected override List<esPropertyDescriptor> GetHierarchicalProperties()
		{
			...
			props.Add(new esPropertyDescriptor(this, "TransactionCollectionByStaffID", typeof(TransactionCollection), new Transaction()));
		...
		protected override void ApplyPostSaveKeys()
		{
			...
			if(this._TransactionCollectionByStaffID != null)
			{
				Apply(this._TransactionCollectionByStaffID, "StaffID", this.StaffID);
			}
		}
	...
	public partial class StaffMetadata : esMetadata, IMetadata
	{
		...
		protected StaffMetadata()
		{
			...
			c = new esColumnMetadata(StaffMetadata.ColumnNames.ResourceColor, 14, typeof(System.String), esSystemType.String);
		...
		private esProviderSpecificMetadata esDefault(string mapName)
		{
			if(!m_providerMetadataMaps.ContainsKey(mapName))
			{
				...
				meta.AddTypeMap("ResourceColor", new esTypeMap("nvarchar", "System.String"));			
